...
export default function ExperienceFour() {
  ...
  return (
    <div>
      <div className='grid grid-cols-7 mt-6 border-b pb-4 border-zinc-300'>
        <h1 className='col-span-2 font-bold label-content'>Work <br /> Experience</h1>
                ...
                <div key={currentItem} id={`expense-${index}`} className='flex space-x-4'>
                  ...
                  <div  className='w-full'>
                    ...
                    <div className='flex gap-x-2 items-center'>
                      <h1 className='font-bold text-md label-content' contentEditable="true">Company</h1>
                    </div>
