...
export default function AchievementEleven() {
  ...
  return (
    <div>
      <div className='grid grid-cols-1 mx-auto'>
        <h1 className=' font-bold tracking-widest mb-4 label-content'>Achievements</h1>
        <div className=''>
              ...
              return (
                <div key={currentItem} id={`expense-${index}`}>
                  <div>
                    ...
                    <p className='text-zinc-500 font-light text-sm label-content' contentEditable="true">Name something you did ilke win an award</p>
                  </div>
                </div>
              )
            } )}
