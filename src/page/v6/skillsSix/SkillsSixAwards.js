...
export default function SkillsSixAwards() {
  ...
  return (
    <div>
      <div className='flex flex-col mb-4 gap-x-8 gap-y-2'>
        <h1 className='font-bold text-xl label-content mb-2 text-zinc-800'>Awards</h1>
        ...
        <button onClick={() => addNewRow()} className="bg-zinc-800 hover:bg-zinc-900 text-white font-normal text-sm py-2 px-4 rounded-xl offPrint label-content">Add Award</button>
    </div>
  )
}
