...
export default function HeadTwelve() {
  return (
    <div className='grid grid-cols-8 gap-y-2 mx-auto mb-2 border-b border-zinc-100 pb-8'>
     <div className='col-span-5'>
        <h1 contentEditable="true" id='StepName' className='font-bold text-3xl text-zinc-700 label-content'>Chris Taylor</h1>
     ...
     <div className='text-right mt-2 col-span-3'>
        <p className='text-zinc-500 font-light text-sm' contentEditable>christaylor.com</p>
        <p className='text-zinc-500 font-light text-sm' contentEditable>hello@christaylor.com</p>
