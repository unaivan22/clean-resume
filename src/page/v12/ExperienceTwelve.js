...
import ExperienceItemsTwelve from './ExperienceItems/ExperienceItemsTwelve';

export default function ExperienceTwelve() {
        ...
        <div className='col-span-5'>
          <div className='grid grid-cols-1 mt-4 mb-4 gap-x-8 gap-y-12'>
            {item?.map((currentItem, index) => {
              return (
                <div key={currentItem} id={`expense-${index}`} className='grid grid-cols-12 relative'>
                  <div className='mt-2 dot-checkpoint col-span-1'><GoPrimitiveDot /></div>
