...
export default function ExperienceSeven() {
  ...
  return (
    <div className='grid grid-cols-7 mt-6 space-x-12 mb-24'>
        <h1 className='font-bold text-zinc-500 tracking-widest label-content col-span-1'>Experience</h1>
                ...
                <div key={currentItem} id={`expense-${index}`}>
                  ...
                  <div className='grid grid-cols-7 mb-12'>
                    <div className='col-span-2'>
                      ...
                      <h1 className='text-zinc-600 text-sm font-medium label-content' contentEditable="true">Job title here</h1>
                      <h1 className='font-normal text-zinc-500 text-sm label-content' contentEditable="true">year - year</h1>
                    </div>
