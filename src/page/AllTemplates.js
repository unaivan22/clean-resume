  ...
  return (
    <div className="grid place-items-center bg-white pt-32 pb-52 min-h-screen">
      <div className='text-white grid grid-cols-1 text-center sm:px-4 xs:px-4'>
        <h1 className='font-bold xl:text-6xl lg:text-6xl md:text-6xl sm:text-4xl xs:text-4xl mx-auto leading-snug text-zinc-900'>Templates that speed up <br className='2xl:block xl:block md:block sm:hidden xs:hidden' /> creating your resume</h1>
