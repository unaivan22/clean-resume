  ...
  return (
    <div className="grid place-items-center bg-zinc-900 pt-32 pb-52">
      <div className='text-white grid grid-cols-1 text-center sm:px-12 xs:px-12'>
        ...
        <div className='grid xl:grid-cols-4 lg:grid-cols-4 md:grid-cols-4 sm:grid-cols-2 xs:grid-cols-2 gap-x-4 gap-y-4 xl:-rotate-6 lg:-rotate-6 md:-rotate-6 sm:rotate-0 xs:rotate-0 lg:px-24 xl:px-24 md:px-24 sm:px-6 xs:px-6'>
