    ...
    <div className='bg-white'>
      <div className="grid place-items-center bg-white 2xl:pt-32 xl:pt-32 md:pt-32 sm:pt-12 xs:pt-12">
        <div className='text-white grid grid-cols-1 text-center sm:px-4 xs:px-4'>
          <h1 className='font-bold xl:text-6xl lg:text-6xl md:text-6xl sm:text-5xl xs:text-5xl mx-auto leading-snug text-zinc-900'>Speed up build of your <br className='2xl:block xl:block md:block sm:hidden xs:hidden' /> template resume</h1>
