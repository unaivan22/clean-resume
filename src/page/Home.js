  ...
  return (
    <div className="grid place-items-center bg-zinc-900 pt-32 pb-52">
      <div className='text-white grid grid-cols-1 text-center sm:px-12 xs:px-12'>
        <h1 className='font-bold xl:text-6xl lg:text-6xl md:text-6xl sm:text-5xl xs:text-5xl mx-auto leading-snug '>I build resume template <br /> that you might be able to use</h1>
